...
type HelloReply struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` //  string time_now = 2;
}
...
var file_api_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x56, 0x31, 0x50, 0x01, 0x5a, 0x17, 0x68, 0x77, 0x2f, 0x61,
